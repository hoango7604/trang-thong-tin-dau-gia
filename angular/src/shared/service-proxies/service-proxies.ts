...
@Injectable()
export class CustomUserServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getCustomUsersByFilter(name: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfCustomUserDto> {
        let url_ = this.baseUrl + "/api/CustomUser/GetCustomUsersByFilter?";
        if (name !== undefined)
            url_ += "Name=" + encodeURIComponent("" + name) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomUsersByFilter(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomUsersByFilter(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfCustomUserDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfCustomUserDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetCustomUsersByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfCustomUserDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfCustomUserDto.fromJS(resultData200) : new PagedResultDtoOfCustomUserDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfCustomUserDto>(<any>null);
    }
     ...
     * @return Success
     */
    getCustomUserForEdit(id: number | null | undefined): Observable<CustomUserInput> {
        let url_ = this.baseUrl + "/api/CustomUser/GetCustomUserForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomUserForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomUserForEdit(<any>response_);
                } catch (e) {
                    return <Observable<CustomUserInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomUserInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetCustomUserForEdit(response: HttpResponseBase): Observable<CustomUserInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CustomUserInput.fromJS(resultData200) : new CustomUserInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomUserInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEditCustomUser(input: CustomUserInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/CustomUser/CreateOrEditCustomUser";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditCustomUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditCustomUser(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrEditCustomUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteCustomUser(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/CustomUser/DeleteCustomUser/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteCustomUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCustomUser(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteCustomUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getCustomUserForView(id: number | null | undefined): Observable<CustomUserForViewDto> {
        let url_ = this.baseUrl + "/api/CustomUser/GetCustomUserForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomUserForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomUserForView(<any>response_);
                } catch (e) {
                    return <Observable<CustomUserForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomUserForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetCustomUserForView(response: HttpResponseBase): Observable<CustomUserForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CustomUserForViewDto.fromJS(resultData200) : new CustomUserForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomUserForViewDto>(<any>null);
    }
}
...
export class PagedResultDtoOfCustomUserDto implements IPagedResultDtoOfCustomUserDto {
    totalCount!: number | undefined;
    items!: CustomUserDto[] | undefined;

    constructor(data?: IPagedResultDtoOfCustomUserDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(CustomUserDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfCustomUserDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfCustomUserDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfCustomUserDto {
    totalCount: number | undefined;
    items: CustomUserDto[] | undefined;
}

export class CustomUserDto implements ICustomUserDto {
    name!: string | undefined;
    address!: string | undefined;
    email!: string | undefined;
    id!: number | undefined;

    constructor(data?: ICustomUserDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomUserDto {
        data = typeof data === 'object' ? data : {};
        let result = new CustomUserDto();
        result.init(data);
        return result;
    }
...
export interface ICustomUserDto {
    name: string | undefined;
    address: string | undefined;
    email: string | undefined;
    id: number | undefined;
...
export class CustomUserInput implements ICustomUserInput {
    name!: string | undefined;
    address!: string | undefined;
    email!: string | undefined;
    id!: number | undefined;

    constructor(data?: ICustomUserInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomUserInput {
        data = typeof data === 'object' ? data : {};
        let result = new CustomUserInput();
        result.init(data);
        return result;
    }
...
export interface ICustomUserInput {
    name: string | undefined;
    address: string | undefined;
    email: string | undefined;
    id: number | undefined;
...
export class CustomUserForViewDto implements ICustomUserForViewDto {
    name!: string | undefined;
    address!: string | undefined;
    email!: string | undefined;

    constructor(data?: ICustomUserForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomUserForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new CustomUserForViewDto();
        result.init(data);
        return result;
    }
...
export interface ICustomUserForViewDto {
    name: string | undefined;
    address: string | undefined;
    email: string | undefined;
}
