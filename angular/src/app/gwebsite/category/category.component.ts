...
export class CategoryComponent extends AppComponentBase
    ...
    createOrEditModal: CreateOrEditCategoryModalComponent;
    @ViewChild("viewCategoryModal")
    viewCategoryModal: ViewCategoryModalComponent;
     ...
     * @param event
     */
    getCategorys(event?: LazyLoadEvent) {
    ...
    reloadList(categoryFullName, event?: LazyLoadEvent) {
        this._categoryService
            .getCategorysByFilter(
                undefined,
    ...
    //hàm show view create MenuCategory
    createCategory() {
