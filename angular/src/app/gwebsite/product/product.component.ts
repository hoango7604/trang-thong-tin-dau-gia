...
export class ProductComponent extends AppComponentBase
    ...
    createOrEditModal: CreateOrEditProductModalComponent;
    @ViewChild("viewProductModal")
    ...
    //hàm show view create MenuProduct
    createProduct() {
