...
export class PaymentComponent extends AppComponentBase
    ...
    createOrEditModal: CreateOrEditPaymentModalComponent;
    @ViewChild("viewPaymentModal")
    viewPaymentModal: ViewPaymentModalComponent;
    ...
    reloadList(paymentFullName, event?: LazyLoadEvent) {
    ...
    init(): void {
        ...
        this._activatedRoute.params.subscribe((params: Params) => {
            this.paymentName = params["name"] || "";
            this.reloadList(this.paymentName, null);
        });
    }
    ...
    //hàm show view create MenuPayment
    createPayment() {
