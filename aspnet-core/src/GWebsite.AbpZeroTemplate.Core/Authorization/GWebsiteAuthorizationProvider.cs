...
namespace GWebsite.AbpZeroTemplate.Core.Authorization
{
    ...
    public class GWebsiteAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var customUser = gwebsite.CreateChildPermission(GWebsitePermissions.Pages_Administration_CustomUser, L("CustomUser"));
            customUser = gwebsite.CreateChildPermission(GWebsitePermissions.Pages_Administration_CustomUser_Create, L("CreatingNewCustomUser"));
            customUser = gwebsite.CreateChildPermission(GWebsitePermissions.Pages_Administration_CustomUser_Edit, L("EditingCustomUser"));
            customUser = gwebsite.CreateChildPermission(GWebsitePermissions.Pages_Administration_CustomUser_Delete, L("DeletingCustomUser"));
        }
